...
class KeySequenceDataset(Dataset):
    ...
    def __init__(self, sequences, key_to_idx, window_size, top_k_hot_keys, target_length_size):
        self.sequences = sequences
        self.key_to_idx = key_to_idx
        self.window_size = window_size
        self.top_k_hot_keys = top_k_hot_keys
        self.vocab_size = len(key_to_idx)
        self.target_length_size = target_length_size
    ...
    def __getitem__(self, idx):
        ...
        # print(self.sequences[idx + 1])
        input_windows = windows 
        target_windows = next_windows
        # target_windows = next_windows[-self.target_windows_size:]   这个地方是一个bug
