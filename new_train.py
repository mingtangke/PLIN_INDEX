...
class DeviceAccessPredictor:
    ...
    def get_recent_sequence(self,log_end_index):
        try:
            begin_index = log_end_index - self.sequence_length
            df = pd.read_csv(self.log_file,
    ...
    def visualize_training_curves(train_losses, test_losses, train_accuracies, test_accuracies, save_path='training_curves.png'):
        plt.figure(figsize=(12, 5))
