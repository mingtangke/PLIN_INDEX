...
constexpr static uint64_t POOLSIZE = 3;
...
constexpr static double MAX_ORPHAN_RATIO = 0.05;
...
// Concurrency control
constexpr static uint32_t lockSet = ((uint32_t)1 << 31);//1000.....
constexpr static uint32_t lockMask = ((uint32_t)1 << 31) - 1;//0111111....
